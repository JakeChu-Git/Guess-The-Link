          ...
          <ThemeProvider theme={theme}>
            ...
            <AppBar position="static" sx={{ backgroundColor: '#fcfaf7', boxShadow: '1', padding: '0.8rem' }}>
              ...
              <Modal open={helpModalOpen} onClose={handleHelpModalClose}>
                <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '70%', height: '63%', maxWidth: 600,
                          overflowY: 'auto', bgcolor: '#fcfaf7', boxShadow: 24, p: 4, }} >
                  ...
                  <Typography variant="body1" mt={2} gutterBottom> 1. Images: Mouse Trap, House, Garage </Typography>
                  <Typography variant="body2" mt={2} gutterBottom> Answer: Types of Music 🎶 </Typography>
                  <Typography variant="body1" mt={2} gutterBottom> 2. Images: Calendar date, Jack (Hammer), Dragon </Typography>
                  <Typography variant="body2" mt={2} gutterBottom> Answer: Types of Fruits 🍉 </Typography>
                  <Typography variant="body1" mt={2} gutterBottom> 3. Images: Mullet (Fish), A Pig's Tail, Buzz Aldrin </Typography>
                  <Typography variant="body2" mt={2} gutterBottom> Answer: Types of Hair Styles💈</Typography>
                </Box>
              </Modal>
            </AppBar>
            <Container component="main" sx={{ flexGrow: 1, pt: 4 }}>
              ...
              <Box component="footer" sx={{ m: '2rem 3.5rem', textAlign: 'right' }}>
                <Box>
                  <IconButton backgroundcolor="#828282" aria-label="email" href="mailto:jakelai2004@gmail.com"><EmailIcon /></IconButton>
                  <IconButton backgroundcolor="#828282" aria-label="linkedin" href="https://www.linkedin.com/in/jake-lai-syd/" target="_blank"><LinkedInIcon /></IconButton>
                </Box>
